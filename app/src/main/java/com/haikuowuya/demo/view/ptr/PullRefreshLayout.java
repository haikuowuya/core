package com.haikuowuya.demo.view.ptr;
...
import com.haikuowuya.demo.view.ptr.drawable.ArcDrawable;
import com.haikuowuya.demo.view.ptr.drawable.CirclesDrawable;
import com.haikuowuya.demo.view.ptr.drawable.MaterialDrawable;
import com.haikuowuya.demo.view.ptr.drawable.RingDrawable;
import com.haikuowuya.demo.view.ptr.drawable.WaterDropDrawable;
...
public class PullRefreshLayout extends ViewGroup
{
    ...
    public static final int STYLE_ARC = 4;
    ...
    private com.haikuowuya.demo.view.ptr.drawable.RefreshDrawable mRefreshDrawable;
    ...
    private int[] mColorSchemeColors = new int[]{0xFFC93437, 0xFF34A350, 0xFF375BF1, 0xFFF7D23E};
    private int mMode;
...
//        mRefreshDrawable.setColorSchemeColors(new int[]{Color.rgb(0xC9, 0x34, 0x37), Color.rgb(0x37, 0x5B, 0xF1), Color.rgb(0xF7, 0xD2, 0x3E), Color.rgb(0x34, 0xA3, 0x50)});
    ...
    public void setRefreshDrawable(com.haikuowuya.demo.view.ptr.drawable.RefreshDrawable drawable)
    {
        setRefreshing(false);
