...
public class SendToWXActivity extends BaseActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        api.registerApp(getString(R.string.tv_wx_key));
        IWXAPI wxApi = WXAPIFactory.createWXAPI(mActivity, getString(R.string.tv_wx_key));
        wxApi.registerApp(getString(R.string.tv_wx_key));
        setContentView(R.layout.activity_wx_send_to_wx);
        initView();
    }
    ...
    private void initView()
    {
                ...
                MMAlert.showAlert(SendToWXActivity.this, getString(R.string.send_img), SendToWXActivity.this.getResources().getStringArray(R.array.send_img_item), null, new MMAlert.OnAlertSelectId()
                        {
                            ...
                            public void onClick(int whichButton)
                            {
                                switch (whichButton)
                                {
                                    ...
                                    case MMAlertSelect3:
                                    {
                                     final  String url = "https://mmbiz.qlogo.cn/mmbiz/dHhJE0dyJozpVeoddvuuIib6Y16uuJH0rgaicXflibmiaQgJIfsCPRE4yaNia3PaZPZVR1w9mqicMFBD48RBxwq1OmCA/0";
                                        new Thread(){
                                            @Override
                                            public void run()
                                            {
        ...
        findViewById(R.id.send_music).setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                MMAlert.showAlert(SendToWXActivity.this, getString(R.string.send_music), SendToWXActivity.this.getResources().getStringArray(R.array.send_music_item), null, new MMAlert.OnAlertSelectId()
                        {
        ...
        findViewById(R.id.send_video).setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                MMAlert.showAlert(SendToWXActivity.this, getString(R.string.send_video), SendToWXActivity.this.getResources().getStringArray(R.array.send_video_item), null, new MMAlert.OnAlertSelectId()
                        {
        ...
        findViewById(R.id.send_webpage).setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                MMAlert.showAlert(SendToWXActivity.this, getString(R.string.send_webpage), SendToWXActivity.this.getResources().getStringArray(R.array.send_webpage_item), null, new MMAlert.OnAlertSelectId()
                        {
        ...
        findViewById(R.id.send_appdata).setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                MMAlert.showAlert(SendToWXActivity.this, getString(R.string.send_appdata), SendToWXActivity.this.getResources().getStringArray(R.array.send_appdata_item), null, new MMAlert.OnAlertSelectId()
                        {
        ...
        findViewById(R.id.send_emoji).setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                MMAlert.showAlert(SendToWXActivity.this, getString(R.string.send_emoji), SendToWXActivity.this.getResources().getStringArray(R.array.send_emoji_item), null, new MMAlert.OnAlertSelectId()
                        {
    ...
    {
        return getString(R.string.tv_activity_send_to_wx);
    }
}
