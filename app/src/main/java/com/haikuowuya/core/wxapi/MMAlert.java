package com.haikuowuya.core.wxapi;
...
public final class MMAlert
{
    ...
    public static AlertDialog showAlert(final Context context, final String msg, final String title, final String yes, final String no, final DialogInterface.OnClickListener lOk, final DialogInterface.OnClickListener lCancel)
    {
        if (context instanceof Activity && ((Activity) context).isFinishing())
        {
            return null;
    ...
    public static AlertDialog showAlert(final Context context, final String title, final View view, final String ok, final String cancel, final DialogInterface.OnClickListener lOk, final DialogInterface.OnClickListener lCancel)
    {
        if (context instanceof Activity && ((Activity) context).isFinishing())
        {
            return null;
    ...
    public static AlertDialog showWebAlert(final Context context, final String title, final String rawUrl, final WebViewClient client, final DialogInterface.OnClickListener lOk, final DialogInterface.OnDismissListener lDismiss)
    {
...
//        return alert;
    ...
    public static AlertDialog showWebAlert(final Context context, final String title, final String rawUrl, final WebViewClient client, final String ok, final String cancel, final DialogInterface.OnClickListener lOk, final DialogInterface.OnClickListener lCancel, final DialogInterface.OnDismissListener lDismiss)
    {
...
//        return alert;
    ...
    public static Dialog showAlert(final Context context, final String title, final String[] items, String exit, final OnAlertSelectId alertDo, OnCancelListener cancelListener)
    {
        ...
        list.setMinimumWidth(cFullFillWidth);
...
class AlertAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        int padding = DensityUtils.dpToPx(context, 10.f);
        if (convertView == null || ((ViewHolder) convertView.getTag()).type != type)
        {
            ...
            textView.setLayoutParams(new AbsListView.LayoutParams(DensityUtils.getScreenWidthInPx(context), DensityUtils.dpToPx(context, 45.f)));
...
//            }
            ...
            holder.text = (TextView) convertView;//(TextView) convertView.findViewById(R.id.popup_text);
            holder.type = type;
        ...
        {
            holder.text.setBackgroundColor(context.getResources().getColor(R.color.color_title_background_color));
