 ...
 * 使用到的基类Activity
 */
public abstract class BaseActivity1 extends AppCompatActivity implements IActivityTitle
{
    protected BaseActivity1 mActivity;
    ...
    private void initToolbar()
    {
        ...
        if (mToolbar != null)
        {
            ...
            boolean isSliding = this instanceof BaseSlidingMenuActivity1;
            int leftPadding = 0;
